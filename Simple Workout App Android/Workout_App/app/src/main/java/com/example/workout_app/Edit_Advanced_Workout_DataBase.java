...
public class Edit_Advanced_Workout_DataBase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_advanced_workout_data_base);
        ...
        EditWorkout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Timer().schedule(new TimerTask(){
                    public void run() {
                        startActivity(new Intent(Edit_Advanced_Workout_DataBase.this, MainActivity.class));
                    }
                }, 3000 );
            }
        });
