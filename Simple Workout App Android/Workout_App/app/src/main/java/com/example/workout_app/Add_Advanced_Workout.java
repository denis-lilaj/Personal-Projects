...
public class Add_Advanced_Workout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_advanced_workout);
        ...
        Add_Advanced_Workout=findViewById(R.id.AddWorkoutButton);

        Bundle bundle=getIntent().getExtras();
        user_Id=bundle.getString("user_Id");


        Add_Advanced_Workout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if (!getWorkoutName.equals("") && !getWorkoutInformation.equals("") && !getWorkoutRepetitions.equals("") && getWorkoutImage!=null) {
                    ...
                    new Timer().schedule(new TimerTask(){
                        public void run() {
                            startActivity(new Intent(Add_Advanced_Workout.this, Advanced_Workout_Activity.class));
                        }
                    }, 3000 );
