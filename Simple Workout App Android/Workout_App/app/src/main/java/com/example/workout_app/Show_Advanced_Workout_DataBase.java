...
public class Show_Advanced_Workout_DataBase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_advanced_workout_data_base);
        ...
        EditWorkout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(Show_Advanced_Workout_DataBase.this,Edit_Advanced_Workout_DataBase.class);
        ...
        DeleteWorkout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Timer().schedule(new TimerTask(){
                    public void run() {
                        startActivity(new Intent(Show_Advanced_Workout_DataBase.this, MainActivity.class));
                    }
                }, 3000 );
            }
        });
